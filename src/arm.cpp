...
Preset presets[MAX_PRESETS] = {
    ...
    { "Red", 10, {
        ...
        { {134, 65, 81, 90, 90, 45}, "Pose 2" },
        { {134, 65, 81, 35, 89, 45}, "Pose 3" },
        { {132, 97, 81, 35, 89, 45}, "Pose 4" },
        { {132, 97, 81, 35, 89, 90}, "Pose 5" },
        { {132, 68, 81, 35, 89, 90}, "Pose 6" },
        { { 90, 68, 81, 26, 89, 90}, "Pose 7" },
        { { 94, 86, 81, 32, 89, 90}, "Pose 8" },
        { { 94, 86, 81, 32, 89, 38}, "Pose 9" },
        { {134, 65, 81, 90, 90, 83}, "Pose 10" },
    } },
    { "Yellow", 9, {
        { {134, 65, 81, 90, 90, 83}, "Pose 1" },
        { {134, 65, 81, 90, 90, 45}, "Pose 2" },
        { {131, 65, 81, 21, 90, 45}, "Pose 3" },
        { {131, 97, 81, 33, 90, 45}, "Pose 4" },
        { {131, 97, 81, 33, 90, 88}, "Pose 5" },
        { {120, 74, 81, 33, 90, 90}, "Pose 6" },
        { { 83, 77, 81, 10, 90, 90}, "Pose 7" },
        { { 83, 77, 81, 10, 90, 42}, "Pose 8" },
        { {134, 65, 81, 90, 90, 83}, "Pose 9" },
    } },
    { "Blue", 9, {
        { {134, 65, 81, 90, 90, 83}, "Pose 1" },
        { {134, 65, 81, 90, 90, 50}, "Pose 2" },
        { {134, 65, 81, 11, 90, 50}, "Pose 3" },
        { {131, 94, 81, 30, 90, 50}, "Pose 4" },
        { {131, 94, 81, 30, 90, 90}, "Pose 5" },
        { {131, 64, 81, 67, 90, 90}, "Pose 6" },
        { {100, 93, 81, 43, 90, 90}, "Pose 7" },
        { {100, 93, 81, 43, 90, 34}, "Pose 8" },
        { {134, 65, 81, 90, 90, 83}, "Pose 9" },
    } },
};
